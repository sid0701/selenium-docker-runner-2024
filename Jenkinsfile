pipeline{
    ...
    stages{
        ...
        stage("Execute Test Suites"){
            steps{
                ...
                script{
                    if(fileExists('results/test_suite_results/testng-failed.xml'))
    ...
    post{
        always{
            ...
            archiveArtifacts artifacts: 'results/test_suite_results/emailable-report.html', followSymlinks: false
        }
    }
}